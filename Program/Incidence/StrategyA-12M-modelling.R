...
for(p in 1:length(years)){
  ...
  for(i in 1 : 20 ){
    ...
    filename=paste("E:\\Conflict\\Tables\\Samples-Revisedversion\\",years[p],"_",i,"_StrategyA_12M_samples.csv",sep='')
    ...
    modelname<-paste("E:\\Conflict\\Model\\",years[p],"_",i,"_BRT_StrategyA_12M.Rdata",sep="")
    ...
    simulate_filename <- paste("E:\\Conflict\\Tables\\Simulation\\StrategyA_12M_ConflictRisk_simulated_",years[p],"_",i,".csv",sep="")
    write.csv(copy_Alldata, file=simulate_filename,row.names=F)
  }
  filename<-paste("E:\\Conflict\\Tables\\Accuracy\\StrategyA_12M_accuracy_",years[p],".csv",sep="")
...
for(ModelYear in 2000:2015){
  ...
  for(SampleYear in 2000:2015){
    for(Modelorder in 1:20){
      modelname<-paste("E:\\Conflict\\Model\\",ModelYear,"_",Modelorder,"_BRT_StrategyA_12M.Rdata",sep="")
      load(modelname)
      
      filename=paste("E:\\Conflict\\Tables\\Samples-Revisedversion\\",SampleYear,"_",Modelorder,"_StrategyA_12M_samples.csv",sep='')
  ...
  save_file<-paste("E:\\Conflict\\Tables\\Performace\\StrategyA_12M_accuracy_",ModelYear,".csv",sep="")
...
filename=paste("E:\\Conflict\\Tables\\Performace\\StrategyA_12M_accuracy_",2000,".csv",sep="")
##load background dataset
data <- read.csv(filename,header=T,encoding="utf-8")
for(ModelYear in 2001:2015){
  filename=paste("E:\\Conflict\\Tables\\Performace\\StrategyA_12M_accuracy_",ModelYear,".csv",sep="")
  
  tempdata <- read.csv(filename,header=T,encoding="utf-8")
  data <- rbind(data, tempdata)
}
data <- subset(data, select = -X)
write.csv(data, file = "E:\\Conflict\\Tables\\Performace\\StrategyA_12M_accuracy.csv")

##Calculate 95%CI ##
data <- read.csv(file = "E:\\Conflict\\Tables\\Performace\\StrategyA_12M_accuracy.csv",header=T,encoding="utf-8")
Accuracy_data <- c()
for(ModelYear in 2000:2015){
  for(SampleYear in 2000:2015){
...
write.csv(Accuracy_data, file="E:\\Conflict\\Tables\\Performace\\Performance_Timecorss_StrategyA_12M.csv",row.names = FALSE,col.names = FALSE,quote = F)
###End###
...
timestart<-Sys.time();
for(order in 1:20){
  filename=paste("E:\\Conflict\\Tables\\Samples-Revisedversion\\2000_",order,"_StrategyA_12M_samples.csv",sep="")
  ##load background dataset
  data <- read.csv(filename,header=T,encoding="utf-8")
  for(ModelYear in 2001:2015){
    filename=paste("E:\\Conflict\\Tables\\Samples-Revisedversion\\",ModelYear,"_",order,"_StrategyA_12M_samples.csv",sep="")
    tempdata <- read.csv(filename,header=T,encoding="utf-8")
    data <- rbind(data, tempdata)
  }
  filename=paste("E:\\Conflict\\Tables\\Samples-Revisedversion\\StrategyA_12M_AllSamples_",order,".csv",sep="")
...
for(i in 1 : 20 ){
  ...
  filename <- paste("E:\\Conflict\\Tables\\Samples-Revisedversion\\StrategyA_12M_AllSamples_",i,".csv",sep="")
  ...
  modelname<-paste("E:\\Conflict\\Model\\BRT_StrategyA_12M_AllSample_",i,".Rdata",sep="")
  
  save(BRT_model, file = modelname)
}
filename<-paste("E:\\Conflict\\Tables\\Accuracy\\StrategyA_12M_AllSample_accuracy.csv",sep="")
write.csv(Accuracy_data, file=filename)
...
for(p in 1:length(years)){
  ...
  for(i in 1 : 20 ){
    modelname <-
      paste("E:\\Conflict\\Model\\BRT_StrategyA_12M_AllSample_",
            i,
            ".Rdata",
            sep = "")
    load(modelname)
    ...
    copy_Alldata$Risk <- pred
    simulate_filename <- paste("E:\\Conflict\\Tables\\Simulation\\All_StrategyA_12M_ConflictRisk_simulated_",years[p],"_",i,".csv",sep="")
    write.csv(copy_Alldata, file=simulate_filename,row.names=F)
  }
}
timeend<-Sys.time()
